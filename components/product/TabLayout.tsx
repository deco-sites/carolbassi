...
function TabLayout({ description, characteristics }: Props) {
  ...
  return (
    <div class="">
      <ul class="relative mx-2 mt-[30px] flex sm:flex-col xl:flex-row justify-between text-xl md:text-2xl text-primary border-b-2 border-b-[rgba(0,0,0,.3)] border-b-solid">
        <li
          class={`${
